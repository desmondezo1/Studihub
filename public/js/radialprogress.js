...
function RadialProgress(container,cfg){
	...
	c.style.position="relative";c.style.top="0";c.style.left="0";c.style.width="100%";c.style.height="100%";c.className="rp_canvas";
	container.appendChild(c);
	this.canvas=c;
	var tcc=document.createElement("div");
	tcc.style.position="relative";tcc.style.display="table";tcc.style.width="100%";tcc.style.height="100%";
