            ...
            <div class="row bg-white has-shadow">
                ...
                <div class="col-xl-3 col-sm-6">
                    <div class="item d-flex align-items-center">
                        ...
                        <div class="title"><span>Courses<br>Purchased</span>
                            <div class="progress">
                ...
                <div class="col-xl-3 col-sm-6">
                    <div class="item d-flex align-items-center">
                        ...
                        <div class="title"><span>Current<br>Progress</span>
                            <div class="progress">
                ...
                <div class="col-xl-3 col-sm-6">
                    <div class="item d-flex align-items-center">
                        ...
                        <div class="title"><span>Questions<br>Attempted</span>
                            <div class="progress">
                ...
                <div class="col-xl-3 col-sm-6">
                    <div class="item d-flex align-items-center">
                        <div class="icon bg-orange"><i class="icon icon-check"></i></div>
                        <div class="title"><span>Question<br>Score</span>
                            <div class="progress">
