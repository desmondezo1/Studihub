                                ...
                                <h4 class="info-color-dark white-text text-center mb-5">
                                    @if(Auth::user()->can('read-admin-admin-student-controller'))
                                        <span class="new-button" style="float:left;">
                                                    ...
                                                    <a href="{{ route('admin.student.enrolled.chart',$student->id) }}" class="btn btn-info btn-sm"><span class="fa fa-plus"></span>
                                                        &nbsp;Visualize Data
                                                    </a>
                                        </span>
                                    @endif
            ...
            <div class="row" data-aos="fade-in"
                ...
                <div class="col-lg-12 col-xs-12">
                    <div class="card">
                        ...
                        <div class="card-header d-flex align-items-center">
                            <h3 class="h4">List of Enrolled Courses for {{ $student->fullname }}</h3>
                        </div>
                        <div class="card-body">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                @if(Auth::user()->can('read-admin-admin-enrolled-course-controller'))
                                                    <a target="_blank" href="{{ route('admin.students.courses.show', $course->id) }}" class="btn btn-info btn-xs"><i class="fa fa-eye" aria-hidden="true"></i> view</a>
                                                @endif
                                                @if(Auth::user()->can('delete-admin-admin-enrolled-course-controller'))
                                                    <button type="button" class="btn btn-danger btn-xs delete" data-url="{{ route('admin.students.courses.destroy', $course->id) }}" data-id="{{ $course->id }}"><i class="fa fa-trash-o"></i> Delete</button>
                                                @endif
                                            </td>
                                        </tr>
                                    @endforeach
