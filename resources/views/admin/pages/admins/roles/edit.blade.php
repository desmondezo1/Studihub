...
@section('description', "Edit Role for Admins")
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-8 mx-auto">
                                    ...
                                    {{ Form::hidden('id', $role->id ,['class'=>'form-control', 'id'=>'slug']) }}
