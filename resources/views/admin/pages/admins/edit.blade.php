...
@section('description', "Edit Admin")
@section('keyword', "teachers,admins")


@section("page-header")
    @component('admin.partials.page-header', [
            'page_name' => 'Edit Admins',
            ])
    @endcomponent
            ...
            <div class="row" data-aos="zoom-in">
                <div class="col-lg-12 col-xs-12">
                    <div class="card">
                        ...
                        <div class="card-header d-flex align-items-center">
                            <h3 class="h4">Edit {{ $admin->fullname }}</h3>
                        </div>
                        <div class="card-body">
                            {!! Form::model($admin, [
                                       'method' => 'PATCH',
                            ...
                            <div class="form-group{{ $errors->has('state') ? ' has-error' : '' }}">
                                <div class="col-md-8 mx-auto">
                                    ...
                                    {{ Form::select('state', $states, $admin->state,['class'=>'form-control']) }}
                                    @if ($errors->has('state'))
                                        <span class="help-block invalid-feedback">
                            ...
                            <div class="form-group{{ $errors->has('city') ? ' has-error' : '' }}">
                                <div class="col-md-8 mx-auto">
                                    ...
                                    {{ Form::text('city', $admin->city,['class'=>'form-control', 'id'=>'city', 'placeholder'=>'City','autofocus'=>true]) }}
                                    @if ($errors->has('city'))
                                        <span class="help-block invalid-feedback">
                            ...
                            <div class="form-group{{ $errors->has('address') ? ' has-error' : '' }}">
                                <div class="col-md-8 mx-auto">
                                    ...
                                    {{ Form::text('address', $admin->address,['class'=>'form-control', 'id'=>'address', 'placeholder'=>'Address','autofocus'=>true]) }}
                            ...
                            <div class="form-group">
                                <div class="col-md-8 mx-auto">
                                    <div class="inform" style="padding: 7px"><img src="{{ $admin->photo }}" width="25%"></div>
