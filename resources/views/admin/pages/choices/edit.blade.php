                ...
                <div class="col-lg-12 col-xs-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            {!! Form::model($choice, [
                                  'method' => 'PATCH',
                                  'route' => ['admin.choices.update', $choice->id],
                                  'role' => 'form',
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <div class="i-checks">
                                        ...
                                        {{ Form::select('question_id', $questions, old('question_id'),['class'=>'form-control custom-select']) }}
                                    </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <div class="i-checks">
                                        {{ Form::text('choice_desc', old('choice_desc'),['class'=>'form-control', 'id'=>'choice_desc', 'placeholder'=>'Choice Desc']) }}
                                    </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <div class="i-checks">
                                        {{ Form::select('choice_option', ['A'=>'A','B'=>'B','C'=>'C','D'=>'D'], old('choice_option'),['class'=>'form-control custom-select']) }}
                                    </div>
                            ...
                            <div class="form-group row is_correct">
                                ...
                                <div class="col-sm-9">
                                    <div class="i-checks">
                                        <input id="is_correct" type="checkbox" name="is_correct" class="checkbox-template" {{ $choice->is_correct ? 'checked ' : 'unchecked '}}>
                            ...
                            <div class="form-group row">
                                <div class="col-sm-4 offset-sm-3">
                                    ...
                                    <button type="submit" name="submit" class="btn btn-primary" data-url="{{ route('admin.choices.update', $choice->id) }}">Save changes</button>
                                </div>
                            </div>
